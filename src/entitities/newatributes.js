  ...
  initializeHealthBars() {
    if (this.playerId === 1) {
      ...
      this.player1HealthBars = [
        this.scene.add
          .sprite(this.x * 0.099, this.y * 0.31 , "healthBarL1F") // EXT 6 HP index 0
          .setVisible(false)
          .setScale(1.155)
          .setDepth(5)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.085, this.y * 0.31 , "healthBarL1") // 5 lifes
          .setVisible(true)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.085, this.y * 0.31 , "healthBarL2") // 4 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.085, this.y * 0.31 , "healthBarL3") // 3 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.085, this.y * 0.31 , "healthBarL4") // 2 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.085, this.y * 0.31 , "healthBarL5") // 1 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.085, this.y * 0.31 , "healthBarLNo") // 0 lifes index 6
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
    ...
    if (this.playerId === 2) {
      ...
      this.player2HealthBars = [
        this.scene.add
          .sprite(this.x * 0.905, this.y * 0.31, "healthBarRF") // add 6 HP index 0
          .setVisible(false)
          .setScale(1.155)
          .setDepth(5)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.915, this.y * 0.31 , "healthBarR1") // 5 lifes
          .setVisible(true)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.915, this.y * 0.31 , "healthBarR2") // 4 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.915, this.y * 0.31 , "healthBarR3") // 3 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.915, this.y * 0.31 , "healthBarR4") // 2 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.915, this.y * 0.31 , "healthBarR5") // 1 lifes
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
        this.scene.add
          .sprite(this.x * 0.915, this.y * 0.31 , "healthBarRNo") // 0 lifes index 6
          .setVisible(false)
          .setScale(1.27)
          .setDepth(2)
          .setOrigin(0.5),
